...
public class Rental extends javax.swing.JFrame {
    ...
    private int Avanza,Panther,Xenia,Kijang,Inova,lama,jum,har;
    ...
    private void combojenisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combojenisActionPerformed
        ...
        if (mobil.equalsIgnoreCase("Pilih Jenis")) {
            ...
            Avanza = 300000;
            txtharga.setText(String.valueOf(Avanza * lama));
        }
        else if (mobil.equalsIgnoreCase("Panther")) {
            Panther = 200000 * lama;
            txtharga.setText(String.valueOf(Panther));
        }
        else if (mobil.equalsIgnoreCase("Xenia")) {
            Xenia = 300000 * lama;
            txtharga.setText(String.valueOf(Xenia));
        }
        else if (mobil.equalsIgnoreCase("Kijang")) {
            Kijang = 300000 * lama ;
            txtharga.setText(String.valueOf(Kijang));
        }
        else if (mobil.equalsIgnoreCase("Inova")) {
            Inova = 300000 * lama;
            txtharga.setText(String.valueOf(Inova));
        }
